...
Actions
More
officialgalaxy.github.io/index.html
@OfficialGalaxy
OfficialGalaxy Add files via upload
 History
 1 contributor
269 lines (190 sloc)  11.6 KB
<!DOCTYPE html>
<html lang="en">
<head>
...
<i class="fa fa-home"></i> Home</a>
                    ...
                    <li class="nav-item">
                        ...
                        <a id="Eventsb" href="#Events" class="nav-link smoothScroll"><i class="fa fa-calendar"></i> Events</a>
                             </li>
                    <li class="nav-item">
                        <a id="Contactsb" href="#Contacts" class="nav-link smoothScroll"><i class="fa fa-phone"></i> Contact</a>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                                ...
                                <p data-aos="fade-up" data-aos-delay="400">We spread sets from other groups to our channel for other people, hidden freshly hacked sets are forbidden to spread. to those who trying to feud Galaxy,<span class="beware"> beware</span>. We Work as One , We have Nothing to Fear.</p>
                                  </div>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="col-lg-12 col-12 text-center mb-5">
                                ...
                                <h2 data-aos="fade-up" data-aos-delay="200">Other Groups</h2>
                             </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="class-thumb">
                                    ...
                                    <div class="class-info">
                                        ...
                                        <p class="mt-3">Calm and Fap, Fap and Calm.</p>
     ...
     <section>
             <h2 class="cncrn">Any Questions? </h2>
 <div id="Contacts" class="box">
         <div class="box5">
         <h2 class="sign">Contact us</h2>
        <form id="my-form" action="https://formspree.io/f/xoqrdrjd" method="POST">
                   
                                <input type="username" class="name" name="username" placeholder="Telegram username" required/>
